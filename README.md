...
- **24** skills ship paired design rationale (EN + ZH) → **48** rationale docs; **14** have complete five-layer coverage (rationale + skill + evaluation + real output example)
...
- **24** ship paired design rationale + evaluation reports; **14** of those also include real output examples (complete five-layer coverage: rationale + skill + evaluation + output example).
