...
12. [将 Skill 融入开发流程](#12-将-skill-融入开发流程)
   - [12.1 本地开发：Makefile 驱动的质量门禁](#121-本地开发makefile-驱动的质量门禁)
   - [12.2 CI 流程：Skill 驱动的自动化门禁](#122-ci-流程skill-驱动的自动化门禁)
   - [12.3 代码审查：AI 驱动的 PR Review](#123-代码审查ai-驱动的-pr-review)
   - [12.4 完整的质量管线](#124-完整的质量管线)
13. [Skill 与其他 Claude Code 特性的关系](#13-skill-与其他-claude-code-特性的关系)
   - [13.1 特性对比](#131-特性对比)
   - [13.2 选择决策树](#132-选择决策树)
   - [13.3 组合使用模式](#133-组合使用模式)
   - [13.4 一句话总结](#134-一句话总结)
14. [AI 编程助手定制能力横向对比](#14-ai-编程助手定制能力横向对比)
   - [14.1 主流工具定制能力对比](#141-主流工具定制能力对比)
   - [14.2 AI 代码审查工具对比](#142-ai-代码审查工具对比)
   - [14.3 趋势判断](#143-趋势判断)
