...
When you need to verify report formatting or check what a complete review report looks like:
→ Load `references/example-output.md` for a full end-to-end report covering Review Mode, Findings (High/Medium), Suppressed Items, Execution Status, Risk Acceptance, Residual Risk, and Summary sections.
