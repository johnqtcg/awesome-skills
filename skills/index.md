...
- **24** ship paired design rationale and evaluation reports; **14** of those also include real output examples (complete five-layer coverage: rationale + skill + evaluation + output example).
